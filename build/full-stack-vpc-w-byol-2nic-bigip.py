...
t.add_description("""\
AWS CloudFormation Template for creating an a full stack with VPC, 4 subnets, 2nic BIG-IP and Bitnami webeserver LAMP stack with username bitnami **WARNING** This template creates Amazon EC2 Instances. You will be billed for the AWS resources used if you create a stack from this template.""")
