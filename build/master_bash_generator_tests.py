...
class test_bash_generator(unittest.TestCase):
    ...
    def test_byol_standalone_1nic_url(self):
        correct_url = "https://s3.amazonaws.com/f5-cft/f5-existing-stack-byol-1nic-bigip.template"
    ...
    def test_hourly_standalone_1nic_url(self):
        correct_url = "https://s3.amazonaws.com/f5-cft/f5-existing-stack-hourly-1nic-bigip.template"
    ...
    def test_byol_standalone_2nic_url(self):
        correct_url = "https://s3.amazonaws.com/f5-cft/f5-existing-stack-byol-2nic-bigip.template"
    ...
    def test_hourly_standalone_2nic_url(self):
        correct_url = "https://s3.amazonaws.com/f5-cft/f5-existing-stack-hourly-2nic-bigip.template"
    ...
    def test_byol_cluster_same_az_2nic_url(self):
        correct_url = "https://s3.amazonaws.com/f5-cft/f5-existing-stack-same-az-cluster-byol-2nic-bigip.template"
    ...
    def test_hourly_cluster_same_az_2nic_url(self):
        correct_url = "https://s3.amazonaws.com/f5-cft/f5-existing-stack-same-az-cluster-hourly-2nic-bigip.template"
    ...
    def test_byol_cluster_across_az_2nic_url(self):
        correct_url = "https://s3.amazonaws.com/f5-cft/f5-existing-stack-across-az-cluster-byol-2nic-bigip.template"
    ...
    def test_hourly_cluster_across_az_2nic_url(self):
        correct_url = "https://s3.amazonaws.com/f5-cft/f5-existing-stack-across-az-cluster-hourly-2nic-bigip.template"
