# Auto scaling the BIG-IP VE Local Traffic Manager (LTM) in AWS: BYOL plus PAYG
...
See [Template Parameters](#template-parameters) for guidance on the parameters presented by the template.
   ...
   <a href="https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=F5-Bigiq-PAYG-BIGIP-LTM-Autoscale&templateURL=https://f5-cft.s3.amazonaws.com/f5-bigiq-payg-autoscale-bigip-ltm.template"><img src="https://s3.amazonaws.com/cloudformation-examples/cloudformation-launch-stack.png"/></a>
