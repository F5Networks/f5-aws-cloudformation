# Auto scaling the BIG-IP VE Local Traffic Manager (LTM) in AWS: Existing Stack with PAYG Licensing (Frontend via NLB)
...
## Introduction
This experimental solution implements auto scaling of BIG-IP Virtual Edition (VE) LTM systems in Amazon Web Services, using PAYG (pay as you go) hourly licensing. 
