# Auto scaling the BIG-IP VE Web Application Firewall in AWS: Existing Stack with PAYG Licensing (Frontend via NLB)
...
## Introduction
This experimental template implements auto scaling of BIG-IP Virtual Edition (VE) Web Application Firewall (WAF) systems in Amazon Web Services, using PAYG (pay as you go) hourly licensing. 
...
<a href="https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=F5-Hourly-BIGIP-WAF-Autoscale&templateURL=https://f5-cft.s3.amazonaws.com/f5-payg-autoscale-bigip-waf-nlb.template"><img src="https://s3.amazonaws.com/cloudformation-examples/cloudformation-launch-stack.png"/></a>   
