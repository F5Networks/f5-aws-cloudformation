# Deploying the BIG-IQ VE License Manager in AWS - 2 NIC: Existing Stack
...
This solution uses an experimental CloudFormation Template to launch a 2-NIC deployment of a BIG-IQ License Manager VE in an Amazon Virtual Private Cloud, using a BYOL (bring your own license) BIG-IQ License Manager License.  
...
See the [BIG-IQ documentation](https://support.f5.com/csp/knowledge-center/software/BIG-IQ?module=BIG-IQ%20Centralized%20Management&version=6.1.0) for more information on these pool types.
...
## Security
This CloudFormation template downloads helper code to configure the BIG-IQ system. If you want to verify the integrity of the template, you can open the CFT and ensure the following lines are present. See [Security Details](#security-details) for the exact code in each of the following sections.
...
<a href="https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=BigIq-2nic-LicMgmt&templateURL=https://f5-cft.s3.amazonaws.com/f5-existing-stack-byol-2nic-bigiq-licmgmt.template">
...
| BIG-IP Image Name | imageName | Yes | F5 BIG-IP Performance Type - Only Best is currently available for this template. |
