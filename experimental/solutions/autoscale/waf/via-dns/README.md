...
**Important**: You may have to select the AWS region in which you want to deploy after clicking the Launch Stack button.
 ...
 - Hourly, which uses pay-as-you-go hourly billing    
   <a href="https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=F5-Hourly-BIGIP-WAF-Autoscale-Dns&templateURL=https://s3.amazonaws.com/f5-cft/f5-hourly-autoscale-bigip-waf-dns.template"><img src="https://s3.amazonaws.com/cloudformation-examples/cloudformation-launch-stack.png"/></a>   
...
| BIG-IP DNS Password | dnsProviderPassword | Yes | BIG-IP DNS management password to use when updating DNS. |
