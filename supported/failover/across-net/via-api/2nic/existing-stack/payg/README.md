# Deploying the BIG-IP VE in AWS - Clustered 2-NIC across Availability Zones: Existing Stack with PAYG Licensing
...
This solution uses a CloudFormation Template to launch and configure two BIG-IP 2-NIC VEs in a clustered, highly available configuration across Amazon Availability Zones, using PAYG (pay as you go) hourly licensing. 
