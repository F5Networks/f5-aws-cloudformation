# Deploying the BIG-IP VE in AWS - Clustered 3-NIC across Availability Zones: Existing Stack with BYOL Licensing
...
This solution uses a CloudFormation Template to launch and configure two BIG-IP 3-NIC VEs in a clustered, highly available configuration across Amazon Availability Zones, using BYOL (bring your own license) licensing.
