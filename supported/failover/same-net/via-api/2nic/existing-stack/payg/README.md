# Deploying the BIG-IP VE in AWS - Clustered 2 NIC - Same Availability Zone: Existing Stack with PAYG Licensing
...
## Introduction
This solution uses a CloudFormation Template to launch and configure two BIG-IP 2-NIC VEs in a clustered, highly available configuration in an Amazon Availability Zone, using PAYG (pay as you go) hourly licensing. 
...
## Important configuration notes 
  ...
  - There are new options for BIG-IP license bundles, including Per App VE LTM, Advanced WAF, and Per App VE Advanced WAF. See the [the version matrix](https://github.com/F5Networks/f5-aws-cloudformation/blob/main/aws-bigip-version-matrix.md) for details and applicable templates.  
