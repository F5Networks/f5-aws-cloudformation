# Deploying the BIG-IP VE in AWS - Clustered 2 NIC - Same Availability Zone: Production Stack with BYOL Licensing
...
## Introduction
This solution uses a CloudFormation Template to launch and configure two BIG-IP 2-NIC VEs in a clustered, highly available configuration in an Amazon Availability Zone, highly available configuration in an Amazon Availability Zone, using BYOL (bring your own license) licensing.
