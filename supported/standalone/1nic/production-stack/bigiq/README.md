# Deploying the BIG-IP VE in AWS - Single NIC: Production Stack with BIG-IQ Licensing
...
<a href="https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=BigIp-1nic-BIGIQ-Prod&templateURL=https://s3.amazonaws.com/f5-cft/f5-prod-stack-bigiq-1nic-bigip.template">  
...
If you want to deploy the template using the AWS CLI(aws-cli/1.11.165), use the example **deploy_via_bash.sh** script available [in this repository](https://github.com/F5Networks/f5-aws-cloudformation/blob/master/supported/standalone/1nic/production-stack/bigiq/deploy_via_bash.sh). Replace the static items (or make them parameters).  
