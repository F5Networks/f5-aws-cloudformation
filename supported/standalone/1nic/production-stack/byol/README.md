# Deploying the BIG-IP VE in AWS - Single NIC: Production Stack with BYOL Licensing
...
## Introduction
This solution uses a CloudFormation Template to launch a single NIC deployment a BIG-IP VE in an Amazon Virtual Private Cloud, using BYOL (bring your own license) licensing.
