...
| BIG-IQ user with privleges to license BIG-IQ (admin or manager) | BIG-IbigiqUsername | Yes (BIG-IQ) | BIG-IQ licensing only: BIG-IQ user with privileges to license BIG-IQ. Can be **admin** or **manager**. |
