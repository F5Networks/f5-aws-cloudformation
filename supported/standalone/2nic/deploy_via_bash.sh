...
then 
    ...
    template="https://f5-cft.s3.amazonaws.com/f5-existing-stack-byol-2nic-bigip.template"
fi 
...
then 
    ...
    template="https://f5-cft.s3.amazonaws.com/f5-existing-stack-payg-2nic-bigip.template"
fi
