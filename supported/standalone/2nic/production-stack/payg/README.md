# Deploying the BIG-IP VE in AWS - 2 NIC: Production Stack with PAYG Licensing
...
This solution uses a CloudFormation Template to launch a 2-NIC deployment of a BIG-IP VE in an Amazon Virtual Private Cloud, using PAYG (pay as you go) hourly licensing.
...
<a href="https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=BigIp-2nic-PAYG-Prod&templateURL=https://s3.amazonaws.com/f5-cft/f5-prod-stack-payg-2nic-bigip.template">  
