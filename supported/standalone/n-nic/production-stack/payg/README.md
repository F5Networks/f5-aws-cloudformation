# Deploying the BIG-IP VE in AWS - N NIC (variable number of additional NICs): Production Stack with PAYG Licensing
...
This multi-NIC solution uses a CloudFormation Template to launch a 3-NIC deployment of a BIG-IP VE in an Amazon Virtual Private Cloud, using PAYG (pay as you go) hourly licensing.  This template can optionally also add additional NIC(s) to the BIG-IP VE to be used as needed, up to 5 additional NICs for a total of 8.  
...
<a href="https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=BigIp-n-nic-PAYG-Prod&templateURL=https://s3.amazonaws.com/f5-cft/f5-prod-stack-payg-n-nic-bigip.template">  
